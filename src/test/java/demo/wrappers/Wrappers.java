...
public class Wrappers {
    ...
    public static void dropdownByVisibleText(ChromeDriver driver, By by, String visibleText) throws InterruptedException {
        WebElement dropdown = driver.findElement(by);
        clickUsingJavaScript(driver, dropdown);
        Thread.sleep(1000); // Wait for dropdown options to be visible
        WebElement option = driver.findElement(By.xpath("(//div[@class='kRoyt MbhUzd']/following-sibling::span[text()='" + visibleText + "'])[2]"));
        if (option != null) {
